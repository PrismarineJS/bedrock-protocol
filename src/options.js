...
// Currently supported version. Prefer the newest runtime we know about, but fall back if minecraft-data
// has not been updated in this checkout yet.
const PREFERRED_CURRENT_VERSION = '1.26.10'
...
const CURRENT_VERSION = Versions[PREFERRED_CURRENT_VERSION] ? PREFERRED_CURRENT_VERSION : '1.26.0'
