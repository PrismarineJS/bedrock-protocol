 ...
 */
Read.enum_size_based_on_values_len = [
  'parametrizable',
  compiler => {
    return compiler.wrapCode(
      js(() => {
...
Write.enum_size_based_on_values_len = [
  'parametrizable',
  compiler => {
    return str(() => {
...
SizeOf.enum_size_based_on_values_len = [
  'parametrizable',
  compiler => {
    return str(() => {
      if (value.values_len <= 0xff) _enum_type = 'byte'
