...
describe('decryption', () => {
  ...
  before(() => {
    ...
    const iv = secretKeyBytes.slice(0, 16)
  ...
  it('decrypt 1', cb => {
    const packet1Encrypted = new Buffer('4B4FCA0C2A4114155D67F8092154AAA5EF', 'hex')
  ...
  it('decrypt 2', cb => {
    const packet2Encrypted = new Buffer('DF53B9764DB48252FA1AE3AEE4', 'hex')
