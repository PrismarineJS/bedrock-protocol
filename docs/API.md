...
| version     | *optional* |  Explicit version override. Otherwise use the supported version advertised by the server pong, falling back to `CURRENT_VERSION` in `src/options.js` if discovery fails, is skipped, or provides no supported version. |
